...
let dday = new Date();
dday.getDate(); // 날짜를 출력 (1부터 시작)
dday.getMonth(); // 월 출력 (0부터 출력하기 때문에 +1)
dday.getDay(); // 요일 출력 (0은 일요일)
...
dday.getFullYear(); // 2023
// d.getYear() // 1900년도부터 연도 계산, 쓰지 않습니다. 잊어버리세요.

// new Date(2023, 6, 30)
new Date(2023, 5, 30); // 6월을 표시하기 위해서는 -1해야 한다. 월은 0부터 시작하기 때문에
