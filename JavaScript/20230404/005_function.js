...
console.log(hello(10)); // console.log(return값)
...
함수1(10, 20, 30, 40); // error가 발생하지 않는다 // 60
...
// 화살표 함수 내부에서 표현식이 한 줄이라면 중괄호를 생략할 수 있습니다.
let 함수3 = (x) => x + 10;
